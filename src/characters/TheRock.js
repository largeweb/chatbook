...
function Socrates() {
  ...
  const cn = "The Rock";
  const cg = "The Rock: I believe in the power of hard work and determination, and I strive to be the best in everything I do. I am dedicated to staying in shape and staying healthy, and I want to inspire others to do the same. I am also committed to giving back to the community and making a positive impact on the world. I am glad you are here with me."; // the first cn# of chars are not visible in the chat
